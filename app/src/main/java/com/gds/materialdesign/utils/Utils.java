    ...
    public static String getUrl(int type, int pageIndex) {
        ...
        switch (type) {
            case NewsFragment.NEWS_TYPE_TOP:
                sb.append(Utils.TOP_URL).append(Utils.TOP_ID);
                break;
            case NewsFragment.NEWS_TYPE_NBA:
                sb.append(Utils.COMMON_URL).append(Utils.NBA_ID);
                break;
            case NewsFragment.NEWS_TYPE_CARS:
                sb.append(Utils.COMMON_URL).append(Utils.CAR_ID);
                break;
            case NewsFragment.NEWS_TYPE_JOKES:
                sb.append(Utils.COMMON_URL).append(Utils.JOKE_ID);
                break;
            default:
                sb.append(Utils.TOP_URL).append(Utils.TOP_ID);
                break;
        }
        sb.append("/").append(pageIndex).append(Utils.END_URL);
        return sb.toString();
    }
