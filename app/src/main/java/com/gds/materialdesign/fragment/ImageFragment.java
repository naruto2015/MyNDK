...
import com.gds.materialdesign.adapter.ImageAdapter;
...
public class ImageFragment extends Fragment implements ImageView, SwipeRefreshLayout.OnRefreshListener,ImageModelImpl.OnLoadImageListListener {
    ...
    private RecyclerView.OnScrollListener mOnScrollListener=new RecyclerView.OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if(newState==RecyclerView.SCROLL_STATE_IDLE
                ...
                //加载更多
                Snackbar.make(getActivity().findViewById(R.id.drawer_layout),"最多20条",Snackbar.LENGTH_SHORT).show();
            }
        }
